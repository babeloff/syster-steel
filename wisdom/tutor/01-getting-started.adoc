...
(the full example is at `steel/examples/hello.scm`):

[source,scheme]
----
include::../../steel/examples/hello.scm[]
----
...
(the full example is at `steel/examples/greetings.scm`):

[source,scheme]
----
include::../../steel/examples/greetings.scm[]
----
